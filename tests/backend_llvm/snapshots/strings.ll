...
@.str.0 = private unnamed_addr constant [13 x i8] c"\73\61\6C\76\65\2C\20\6D\75\6E\64\69\00"
define %scriptum.value @principalis() {
entry:
  %base.slot1 = alloca %scriptum.value
  %null2 = call %scriptum.value @scriptum_value_null()
  %text.data3 = getelementptr inbounds [13 x i8], [13 x i8]* @.str.0, i32 0, i32 0
  %text.new4 = call %scriptum.text* @scriptum_text_new(i8* %text.data3, i64 12)
  %str5 = call %scriptum.value @scriptum_value_text(%scriptum.text* %text.new4)
  store %scriptum.value %str5, %scriptum.value* %base.slot1
  %null6 = call %scriptum.value @scriptum_value_null()
  %load7 = load %scriptum.value, %scriptum.value* %base.slot1
  ret %scriptum.value %load7
}
